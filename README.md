...
Convert raw kiro-cli session logs into compact structured YAML for analysis. Strips
tool output noise, preserves user messages, agent reasoning, and tool metadata.
...
- [Digest](docs/digest.md) — session log digestion
